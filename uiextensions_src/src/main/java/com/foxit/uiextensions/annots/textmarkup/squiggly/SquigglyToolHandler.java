...
public class SquigglyToolHandler implements ToolHandler {
    ...
    public void addAnnot(final int pageIndex, ArrayList<RectF> rectArray, final RectF rectF, SelectInfo selectInfo, final Event.Callback result) {
        PDFPage page = null;
        Squiggly annot = null;
        try {
